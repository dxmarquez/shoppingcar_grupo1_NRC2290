...
ValueNotifier<int> product0 = ValueNotifier<int>(0);
ValueNotifier<int> prodyct1 = ValueNotifier<int>(0);
...
class _ProductListState extends State<ProductList> {
  ...
  Widget _card(Product product) {
    ValueNotifier<int> tproduct = ValueNotifier<int>(product.quantity.toInt());
    void tmp_add_product() {
      tproduct.value++;
    }

    void tmp_remove_product() {
      if (tproduct.value > 0) {
        tproduct.value--;
      }
    }
